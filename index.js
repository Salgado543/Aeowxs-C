...
let { say } = cfonts
console.log(chalk.magentaBright('\nOjala vayas con suertes 😆'))
say('Morchi', {
font: 'simple',
align: 'left',
gradient: ['green', 'white']
})
say('Test by Dev Criss 🇦🇱', {
font: 'console',
align: 'center',
...
console.log(chalk.bold.white(chalk.bgMagenta(`Fast cielo este es el code`)), chalk.bold.white(chalk.white(codeBot)))
}, 3000)
}}}}
conn.isInit = false;
conn.well = false;
conn.logger.info(`Avisas si hay error fast\n`)
if (!opts['test']) {
