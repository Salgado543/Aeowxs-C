...
const _svg = readFileSync(join(mediaDir, 'welcome.svg'), 'utf-8');
...
const genSVG = async ({
  wid = '',
  pp = join(mediaDir, 'avatar_contact.png'),
  title = '',
  name = '',
  text = '',
  background = '',
...
const render = async ({
  wid = '',
  pp = toBase64(readFileSync(join(mediaDir, 'avatar_contact.png')), 'image/png'),
  name = '',
  title = '',
  text = '',
  background = toBase64(readFileSync(join(mediaDir, 'Aesthetic', 'Aesthetic_000.jpeg')), 'image/jpeg'),
} = {}, format = 'png') => {
