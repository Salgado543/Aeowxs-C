...
let handler = async (m, { conn }) => {  
  const quotedImage = m.quoted?.message?.imageMessage
  const directImage = m.message?.imageMessage
  
  const image = quotedImage || directImage
  if (!image)
    return m.reply('➤ `ACCION MAL USADA` ❗\n\n> 𝖲𝗂𝗀𝗎𝖾 𝖾𝗌𝗍𝗈𝗌 𝗉𝖺𝗌𝗈𝗌: 𝖤𝗇𝗏𝗂𝖺 𝗅𝖺 𝗂𝗆𝖺𝗀𝖾𝗇 𝗋𝖾𝗌𝗉𝗈𝗇𝖽𝗂𝖾𝗇𝖽𝗈 𝗈 𝗎𝗌𝖺𝗇𝖽𝗈 𝖾𝗅 𝖼𝗈𝗆𝖺𝗇𝖽𝗈 𝗃𝗎𝗇𝗍𝗈 𝖺 𝖾𝗅𝗅𝖺.\n\n» 𝖤𝗃𝖾𝗆𝗉𝗅𝗈 𝖽𝖾 𝗎𝗌𝗈:\nResponde a una imagen o envíala con el comando: #setppbot waza')  
